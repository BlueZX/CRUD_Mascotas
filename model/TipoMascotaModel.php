...
class TipoMascotaModel extends DBAbstractModel{
	public $descripcion;
	public $id;
		...
		if(count($this->rows) == 1){
			...
			$this->msj = '<div class="alert alert-success alert-dismissable">
							<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  							<strong>Realizado!</strong> tipo_mascota encontrado.
						  </div>';
			...
			<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>A ocurrido un error!</strong> no se encuentra el tipo_mascota.
</div>';
		}
	}
	# Traer Lista
	...
	public function set($data=array()){
		if($data['id']!=null){
			...
			if($data['id'] != $this->id) {
				...
				$this->msj = '<div class="alert alert-success alert-dismissable">
							<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  							<strong>Realizado!</strong> tipo_mascota agregado exitosamente.
						  </div>';
				$this->executeSQuery();
			}
			else{
				$this->msj = '<div class="alert alert-warning">
  <strong>Peligro!</strong> el tipo_mascota que desea agregar ya existe.
</div>';
			}
		}
		else{
  ...
  <strong>No se a podido agregar!</strong> has dejado un valor en blanco.
	...
	public function edit($data=array()) {
		...
		$this->msj = '<div class="alert alert-success alert-dismissable">
							<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  							<strong>Realizado!</strong> tipo_mascota modificado exitosamente.
						  </div>';
		$this->executeSQuery();
	}
	...
	public function delete($iid='') {
		...
		$this->msj = '<div class="alert alert-success alert-dismissable">
							<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  							<strong>Realizado!</strong> tipo_mascota eliminado exitosamente.
						  </div>';
		$this->executeSQuery();
	}
	# Método constructor
