...
class BMascotaController{
    ...
    $aux = '';
		$rows = $ba->getList();
    $aux .= "</h1><h2>Boleta Mascota</h2><a class=\"btn btn-success\" href=\"?c=BMascota&a=addform\">Agregar</a><div class=\"table-responsive\"><table class=\"table table-striped\"><thead><tr><th>id</th><th>fecha venta</th><th>monto neto</th><th>iva</th><th>total</th><th>cliente</th><th>empleado</th><th>Accion</th></tr></thead><tbody>";
    for($i=0;$i<count($rows);$i++){
      ...
      $aux .= "\t<td><a href=\"?c=BMascota&a=editform&id=" . $ba->id . " \"class=\"btn btn-success\">Editar</a><a href=\"?c=BMascota&a=delete&id=" . $ba->id . " \"class=\"btn btn-danger\">Eliminar</a></td></tr>\n";
    }
    $aux .= "</tbody></table>\n";
    echo $aux;
  ...
  function addform(){
    ...
    echo ' > Agregar</h1><h2>Agregar Boleta Mascota:</h2>
      <form class="form-horizontal" action="?c=BMascota&a=add" method="post">
  ...
  function editform(){
    ...
    $aux = ' > Editar</h1><h2>Editar Boleta Mascota:</h2>
      <form class="form-horizontal" action="?c=BMascota&a=edit" method="post">
        <div class="form-group">
          <label class="control-label col-sm-2">
            id:
          </label>
	...
	function nav(){
		echo '<nav class="col-sm-3 col-md-2 d-none d-sm-block sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="?c=BMascota&a=list">Boletas Mascotas</a>
            </li>
          </ul>
